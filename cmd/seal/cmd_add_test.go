...
func TestFindRuleSanity(t *testing.T) {
	packages := []api.PackageVersion{
		{
			Version:                         "1.2.3",
			Library:                         api.Package{Name: "Snappier", NormalizedName: "snappier", PackageManager: mappings.NugetManager},
			RecommendedLibraryVersionId:     "111",
			RecommendedLibraryVersionString: "1.2.3-sp1",
		},
		{
			Version:                         "1.0.0",
			Library:                         api.Package{Name: "tinymce", NormalizedName: "tinymce", PackageManager: mappings.NugetManager},
	...
	if foundPackage.Library.NormalizedName != toFind.Library.NormalizedName {
...
func TestFindRuleNotFoundLibrary(t *testing.T) {
	...
	toFind := api.PackageVersion{
		...
		Version:                         "1.2.3",
		Library:                         api.Package{Name: "powershell", NormalizedName: "powershell", PackageManager: mappings.NugetManager},
		RecommendedLibraryVersionString: "1.2.3-sp1",
	}
...
func TestFindRuleNotFoundEmpty(t *testing.T) {
	...
	toFind := api.PackageVersion{
		...
		Version:                         "1.2.3",
		Library:                         api.Package{NormalizedName: "powershell", Name: "powershell", PackageManager: mappings.NugetManager},
		RecommendedLibraryVersionString: "1.2.3-sp1",
	}
...
func TestUpsertAddedNew(t *testing.T) {
	existing := []api.PackageVersion{
		{
			Version:                         "1.2.3",
			Library:                         api.Package{NormalizedName: "snappier", Name: "Snappier", PackageManager: mappings.NugetManager},
			RecommendedLibraryVersionId:     "111",
			RecommendedLibraryVersionString: "1.2.3-sp1",
		},
		{
			Version:                         "1.0.0",
			Library:                         api.Package{NormalizedName: "tinymce", Name: "tinymce", PackageManager: mappings.NugetManager},
			RecommendedLibraryVersionId:     "123123",
			RecommendedLibraryVersionString: "1.0.0-sp1",
		},
	}
	...
	resolved := phase.ResolvedRule{
		From: api.PackageVersion{
			Version:                         "2.7.4",
			Library:                         api.Package{NormalizedName: "npgsql", Name: "npgsql", PackageManager: mappings.NugetManager},
...
func TestParseRuleArgsTooMany(t *testing.T) {
	r, err := parseRule([]string{"npgsql", "1.2", "npgsql2"})
	if err == nil || r != nil {
		t.Fatalf("failed detecting empty input")
	}
}
func TestParseRuleArgsSanity(t *testing.T) {
	r, err := parseRule([]string{"npgsql", "1.2"})
	if err != nil || r == nil {
		t.Fatalf("failed parsing input")
	}

	if r.From.Library != "npgsql" {
