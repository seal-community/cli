...
func (m *PnpmPackageManager) ListDependencies(be api.Backend) (common.DependencyMap, error) {
...
func (m *PnpmPackageManager) SilencePackages(silenceArray []api.SilenceRule, allDependencies common.DependencyMap) (map[string][]string, error) {
